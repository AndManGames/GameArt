...
def test_key_press_and_release_duration_zero():
    ...
    Case 1: Simulate key presses and releases of one Key with 0s duration.
        Output csv should only contain 1 row with the values 'Key' and 'Duration' of the Key
    """
...
def test_key_press_and_release_duration_one():
    ...
    Case 2: Simulate key presses and releases of one Key with 1s duration.
        Output csv should only contain 2 rows with the values 'Key' and 'Duration' the previous test and this one
    """
...
def test_one_successful_and_one_unsuccessful_key_press():
    """
    Case 3: Simulate key presses and releases of one Key and simulate only a key press without a release of another Key.
        Output csv should only contain 3 rows with the values 'Key' and 'Duration' the previous tests and this one
    """
